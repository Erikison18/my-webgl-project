...
function withSubscription(WrappedComponent, selectData) {
  ...
  return class SubscriptionData extends React.Component {
    constructor(props) {
      super(props);
...
class App extends React.Component {
  ...
  render() {
    return <div>
      ...
      <div>
        <MyComponent requiredAny={true} requiredFunc={() => console.log("requiredFunc")} customProp={"matchme6u"}></MyComponent>
      </div>
